...
const Minion := "res://game/game_object/enemies/skeleton.tscn"
const Arrow := preload("res://game/game_object/enemies/arrow/arrow.tscn")
...
func is_good_position(p_position: Vector2) -> bool:
	var query_parameters = PhysicsRayQueryParameters2D.create(global_position, p_position, 1 << 2)
